      ...
      <div class="box">
        ...
        <a href="?page=data_pesertacalon" class="btn bg-navy btn-flat margin"><span class="fa fa-mail-reply (alias)""></span> Data Calon Peserta</a>
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                <?php
                $query = mysqli_query($CON, "SELECT * FROM tb_pendaftaran,tb_periode,tb_jenismagang WHERE tb_pendaftaran.id_magang=tb_jenismagang.id_magang and tb_pendaftaran.id_periode=tb_periode.id_periode and tb_pendaftaran.status='ditolak'");
                $no = 1;
