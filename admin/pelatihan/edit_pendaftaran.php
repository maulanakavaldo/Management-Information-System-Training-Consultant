...
if (isset($_POST['simpan'])) {
    ...
    $simpan = mysqli_query($CON, "UPDATE tb_pendaftaran SET status='$nama_pelatihan' WHERE id_pendaftaran='$id'") or die(mysqli_error($CON));
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="nama_plt" value="<?php echo $data['nama']; ?>" placeholder="" required>
                                        </div>
                                    </div>
