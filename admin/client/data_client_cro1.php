                  ...
                  <div class="x_panel">
                    ...
                    <div class="x_content">
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php
                          $query = mysqli_query($CON, "SELECT * FROM tb_client INNER JOIN tb_perusahaan ON tb_client.id_psh=tb_perusahaan.id_psh inner join tb_bidangpsh on tb_perusahaan.id_bidangpsh=tb_bidangpsh.id_bidangpsh where tb_perusahaan.cro='Wulan';");
                          $no = 1;
