...
if (@$_POST['id_jenispelatihan']) {
	...
	class FPDF_AutoWrapTable extends FPDF
	{
		...
		public function rptDetailData()
		{
			...
			$this->SetFont("", "B", 12);
			$this->SetX($left);
			$this->Cell(0, 10, 'Laporan Data Kehadiran Pelatihan ' . explode('|', $_POST['id_jenispelatihan'])['1'], 0, 1, 'C');
			$this->Ln(10);
	...
	$s_pendamping = mysqli_query($CON, "SELECT * FROM tb_pendaftaran natural join tb_pelatihan where id_jenispelatihan = '" . addslashes(@$id_jenispelatihan) . "' and status='diterima'") or die(mysqli_error($CON));
