    ...
    <div class="main_container">
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              ...
              <ul class="nav side-menu">
                ...
                <li><a href="?page=data_pelatihan"><i class="fa fa-folder"></i> Data Pelatihan</a></li>
                ...
                <li><a href="?page=data_peserta"><i class="fa fa-user"></i> <span>Data Peserta</span></a></li>
                ...
                <ul class="nav child_menu">
                  ...
                  <li><a href="?page=laporan_pendamping"> Data Laporan Perusahaan</a></li>
          ...
          <div class="sidebar-footer hidden-small">
            <a data-toggle="tooltip" data-placement="top" title="Settings" href=" ?page=edit_user&id=<?php echo $userlogin; ?>">
      ...
      <footer>
        <div class="pull-right">
          <b>Jogja Smart Indotama </b> by <a href="https://colorlib.com">Copyright &copy; 2021</a>
        </div>
        <div class="clearfix"></div>
      </footer>
      <!-- /footer content -->
