                ...
                <div class="x_content">
                  ...
                  <table id="datatable" class="table table-striped table-bordered">
                    ...
                    <tbody>
                      ...
                      //$query = mysqli_query($CON, "SELECT tb_user.nama, tb_pelatihan.nama_pelatihan, tb_pelatihan.tgl_mulai, tb_pelatihan.tgl_akhir, tb_pelatihan.tempat, tb_pendaftaran.jmlh_peserta  FROM tb_user Inner JOIN tb_pendaftaran on tb_user.id_user=tb_pendaftaran.id_user inner join tb_pelatihan on tb_pendaftaran.id_pelatihan=tb_pelatihan.id_pelatihan where tb_user.id_user = '$userlogin' ");
                      $query = mysqli_query($CON, "SELECT * FROM tb_user Inner JOIN tb_pendaftaran on tb_user.id_user=tb_pendaftaran.id_user inner join tb_pelatihan on tb_pendaftaran.id_pelatihan=tb_pelatihan.id_pelatihan inner join tb_status on tb_pendaftaran.id_status=tb_status.id_status where tb_user.id_user = '$userlogin' ");
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            if ($data['status'] == 'Sudah Bayar') {
                              echo "<span class='btn btn-success btn-xs' style='text-align: center;'>" . $data['status'] . "</span>";
                            } else {
                              echo "<span class='btn btn-warning btn-xs'>" . $data['status'] . "</span>";
                            }
                          ...
                          <td style=" text-align: center; width:'auto-width'">
                            <a href="?page=edit_pendaftaran&id=<?php echo $data['id_pendaftaran']; ?>" class="btn btn-warning fa fa-pencil"></a>
                            <a href="?page=hapus_pendaftaran&id=<?php echo $data['id_pendaftaran']; ?>" class="btn btn-danger fa fa-trash-o" onclick="return confirm('Hapus Data Ini?');"></a>
                          </td>
                        </tr>
                      <?php
                        $no++;
