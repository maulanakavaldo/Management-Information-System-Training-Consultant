	...
	class FPDF_AutoWrapTable extends FPDF
	{
		...
		public function rptDetailData()
		{
			...
			while ($dataa = mysqli_fetch_array($sqla)) {
				$this->SetX($left);
				$this->Cell(0, 10, 'Laporan Data Peserta Magang ' . $dataa['nama_magang'], 0, 1, 'C');
			}
			//---
			$this->Ln(10);
			...
			$this->SetX($left += 20);
			$this->Cell(50, $h, 'ID Peserta', 1, 0, 'C', true);
			$this->SetX($left += 50);
			$this->Cell(90, $h, 'No KTP', 1, 0, 'C', true);
			$this->SetX($left += 90);
			$this->Cell(150, $h, 'Nama Peserta', 1, 0, 'C', true);
			$this->SetX($left += 150);
			$this->Cell(40, $h, 'Jekel', 1, 0, 'C', true);
			$this->SetX($left += 40);
			$this->Cell(140, $h, 'Alamat', 1, 0, 'C', true);
			$this->SetX($left += 140);
			$this->Cell(100, $h, 'Usaha', 1, 0, 'C', true);
			$this->SetX($left += 100);
			$this->Cell(70, $h, 'Hasil Produk', 1, 0, 'C', true);
			$this->SetX($left += 70);
			$this->Cell(100, $h, 'No.Telp', 1, 0, 'C', true);
			$this->SetX($left += 100);
			$this->Cell(80, $h, 'Nama Magang', 1, 0, 'C', true);
			$this->SetX($left += 80);
			$this->Cell(40, $h, 'Periode', 1, 0, 'C', true);
