...
<?php
} elseif ($_GET['page'] == 'hapus_pendaftaran') {
  $id = $_GET['id'];
  $query = "DELETE FROM tb_pendaftaran WHERE id_pendaftaran='$id'";
  ...
  if ($query_hapus) {
    ...
    echo "<div class='alert alert-warning'>
        <a href='data_peserta' class='close' data-dismiss='alert'>
        &times;
        </a> Hapus Data Gagal
        </div>";
...
} elseif ($_GET['page'] == 'edit_pendaftaran') {
  include "peserta/edit_pendaftaran.php";
...
} elseif ($_GET['page'] == 'daftar_pelatihan') {
  include "pelatihan/daftar_pelatihan.php";
