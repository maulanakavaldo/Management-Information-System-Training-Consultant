...
if (isset($_POST['simpan'])) {
  ...
  if ($foto_cek == "") {
    $simpan = mysqli_query($CON, "UPDATE tb_user SET nama='$nama', jekel='$jekel', alamat='$alamat', 
    no_hp='$no_hp', username='$username', password='$password' WHERE id_user='$id'") or die(mysqli_error($CON));
  } else {
    ...
    $simpan = mysqli_query($CON, "UPDATE tb_user SET  nama='$nama', jekel='$jekel', alamat='$alamat', 
    no_hp='$no_hp', username='$username', password='$password', foto='$foto' WHERE id_user='$id'") or die(mysqli_error($CON));
  }

  if ($simpan) {
    echo "<div class='right_col' role='main'>
    <div class='alert alert-success'>
    <a href='index.php' class='close' data-dismiss='alert'>
    &times;
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" name="password" placeholder="ganti password" value="<?php echo $data['password']; ?>" required>
                  </div>
                </div>
                <div class="form-group">
