...
<head>
  ...
  <title>Jogja Smart Indotama | Log in </title>
...
<body style="background-image: url( 'foto/logo/LP_JSI.jpg'); background-repeat: no-repeat; background-size:cover;">
  <div class="login-box">
    <!-- <div class="login-logo">
      <a href="#">
        <br>Jogja SMart Indotama</br></a>
    </div> -->
    <!-- /.login-logo -->
    <br><br><br><br>
